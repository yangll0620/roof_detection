...
class TargetAssigner(object):
  ...
  def assign(self,
    ...
    groundtruth_boxes.add_field(standard_fields.BoxListFields.scores, scores)
  ...
  def _create_regression_targets(self, anchors, groundtruth_boxes, match):
    ...
    if groundtruth_boxes.has_field(standard_fields.BoxListFields.keypoints):
      ...
      matched_gt_boxlist.add_field(standard_fields.BoxListFields.keypoints,
                                   matched_keypoints)
